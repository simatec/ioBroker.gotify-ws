...
class GotifyWs extends utils.Adapter {
	...
	async onReady() {
		...
		this.log.info("config signalInstance: " + this.config.signalInstance);
		this.log.info("config telegramInstance: " + this.config.telegramInstance);
		this.log.info("config whatsappInstance: " + this.config.whatsappInstance);
